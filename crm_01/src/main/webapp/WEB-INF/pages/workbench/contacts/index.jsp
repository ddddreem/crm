                ...
                success: function (data) {
                    if (data.code == '1') {
                        ...
                        $.each(data.extend.pageInfo.list, function (index, obj) {
                            ...
                            htmlStr += "<td><a style=\"text-decoration: none; cursor: pointer;\" onclick=\"window.location.href=ddetail.jsp\">" + obj.fullname + "</a></td>";
	...
	<div class="modal fade" id="editContactsModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" id="updateContactBtn">更新</button>
				</div>
			</div>
		</div>
	</div>
