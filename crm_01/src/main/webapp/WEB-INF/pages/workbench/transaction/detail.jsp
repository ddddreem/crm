...
<body>
	...
	<div id="remarkDivList" style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach items="${tranRemarks}" var="tr">
			<div id="div_${tr.id}" class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${tr.editFlag == '1' ? tr.editTime : tr.createTime} 由&nbsp;${tr.editFlag == '1' ? tr.editBy : tr.createBy}&nbsp;${tr.editFlag == '1' ? "修改" : "创建"}</small>
